...
![Small 3D printed Y3 quadcopter](/res/ydrone_thumb.png)
...
I found some ~~cursed~~ cheap motors on AliExpress (about 0.75$ each, similar to the ones that are commonly used in cheap chinese camera drones and DJI lookalikes) and felt like making a 3D printed quad with spare parts. I decided to go with a Y4 configuration, simply because it looks cool.
...
> 
> **Use liquid cyanoacrylate / super glue** generously. Glue all touching surfaces, except for the top cover plate and inverse motor mounting plate. Those should be held in place with screws only.
